...
class ZoomController {
    ...
    transformElements(svg, xZoom, yZoom) {
        ...
        // Transform rects (phrase boxes in annotated section)
        svg.querySelectorAll('rect').forEach(rect => {
            const baseX = parseFloat(rect.dataset.baseX || rect.getAttribute('data-base-x'));
            const baseY = parseFloat(rect.dataset.baseY);
            const baseWidth = parseFloat(rect.dataset.baseWidth || rect.getAttribute('data-base-width'));
            const baseHeight = parseFloat(rect.dataset.baseHeight);
        ...
        svg.querySelectorAll('g[data-base-x]').forEach(group => {
            const baseX = parseFloat(group.dataset.baseX || group.getAttribute('data-base-x'));
