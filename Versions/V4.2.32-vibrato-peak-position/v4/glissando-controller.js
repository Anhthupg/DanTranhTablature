...
╚═══════════════════════════════════════════════════════════════╝
    ...
    drawGlissandoForCandidate(candidateNoteIndex, customXDelta = null) {
        ...
        // Note: candidateNote.x/y already contain BASE positions
        // (extracted by extractNotesFromSVG which prefers dataset.baseCx/baseCy)
    ...
    drawGlissandoToNote(targetNoteIndex, xDelta) {
        ...
        // Note: targetNote.x/y already contain BASE positions
        // (extracted by extractNotesFromSVG which prefers dataset.baseCx/baseCy)
