...
app.get('/word-journey', (req, res) => {
    const pageTemplate = fs.readFileSync(path.join(__dirname, 'templates', 'word-journey-sankey-page.html'), 'utf8');
    const wordJourneySankey = fs.readFileSync(path.join(__dirname, 'templates', 'components', 'word-journey-sankey.html'), 'utf8');

    const html = pageTemplate.replace(/{{WORD_JOURNEY_SANKEY_COMPONENT}}/g, wordJourneySankey);
