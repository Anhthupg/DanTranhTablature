...
if (require.main === module) {
    ...
    if (testFile) {
        ...
        console.log(`
╔════════════════════════════════════════════════════════════════════╗
║                 Musical Relationship Parser v1.0                   ║
║                                                                     ║
║  Complete relationship tracking for Dan Tranh music:               ║
║  • Grace note to main note relationships                          ║
║  • Melisma detection and lyric spanning                          ║
║  • Vietnamese linguistic tone analysis                            ║
║  • Multi-dimensional pattern relationships                        ║
║  • Critical: Different lyrics = separate notes (not tied)        ║
╚════════════════════════════════════════════════════════════════════╝

Usage:
  node musical-relationship-parser.js <musicxml-file>

Example:
  node musical-relationship-parser.js v3/data/musicxml/Cô\\ nói\\ sao.musicxml.xml
        `);
    }
}